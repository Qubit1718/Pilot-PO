...
if st.button('Rebalancing'):
    ...
    fig_rebalancing.add_trace(go.Scatter(x=df_fta['Date'], y=df_fta['Value'], mode='lines+markers', name='Portfolio With Rebalancing', line=dict(color='red'), showlegend=True))
    fig_rebalancing.add_trace(go.Scatter(x=filtered_data['Date'], y=filtered_data['Portfolio Value'], mode='lines+markers', name='Portfolio Without Rebalancing', line=dict(color='blue'), showlegend=True))
